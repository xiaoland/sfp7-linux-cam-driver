...
- New project-authored documentation, `scripts/prepare-kernel.sh`, and `runtime/` helper/configuration files are offered under the [MIT License](LICENSES/MIT.txt), except portions copied from separately licensed upstream material. This grant does not relicense a kernel, libcamera, Snapshot, firmware, or any third-party patch.
